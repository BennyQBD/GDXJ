...
public class Test
{
	public static void main(String[] args)
	{
		...
		GameObject cube = new GameObject(new RenderableMesh(Mesh.get("cube"), bricks));
		...
		GameObject cube2 = new GameObject(new RenderableMesh(Mesh.get("cube"), bricks));
		//cube.addComponent(new ChaseComponent());
		cube2.getTransform().move(new Vector3f(3,-0.5f,7));
		cube2.getTransform().rotate(new Vector3f(0,-30,0));
		
		GameObject floor = new GameObject(new RenderableMesh(Mesh.get("plane"), Material.getDefaultMaterial()));
